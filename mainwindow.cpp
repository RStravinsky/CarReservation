...
//    }
    ...
    carBlockVector.emplace_back(std::move(new CarBlock("VW", "Golf", "LU 3456H", "free",QDate::currentDate(),QDate::currentDate(),100000,"notes", CarBlock::Free,":/images/images/corolla.jpg")));
